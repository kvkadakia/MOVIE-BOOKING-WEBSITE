...
<?php
	...
	if (isset($_POST['seats']))
	{
		...
		if ($selectedSeats != $count) {
			...
			//$problem .= "</ul>";
			$problem .= "<a href='seats8.php'>View Seat Plan</a>";
		...
		echo "<a href='seats8.php'>View Seat Plan</a>";
		...
		mysql_close();
		echo "<meta http-equiv='refresh' content='0;url=http://localhost:1337/Project/Bookings/seats8.php' />";
	}
