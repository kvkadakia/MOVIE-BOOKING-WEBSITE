...
<?php
	...
	if (isset($_POST['seats']))
	{
		...
		if ($selectedSeats != $count) {
			...
			//$problem .= "</ul>";
			$problem .= "<a href='seats5.php'>View Seat Plan</a>";
		...
		echo "<a href='seats5.php'>View Seat Plan</a>";
		...
		mysql_close();
		echo "<meta http-equiv='refresh' content='0;url=http://localhost/Project/Bookings/seats5.php' />";
	}
