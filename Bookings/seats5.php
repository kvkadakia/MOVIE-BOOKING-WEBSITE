...
#bookin a:active{
	...
	<script>
		...
		function reserveSeats() {
			...
			if (selectedList) {
				if (confirm('Do you want to reserve selected seat/s ' + selectedList + '?')) {
					...
					document.forms[0].action='bookseats5.php';
		...
		function confirmSeats() {
			document.forms[0].action='Payment5.html';
					document.forms[0].submit();
		}
...
<marquee>Welcome to Movie Center</marquee>
</div>
<br>
<div id="run" style="font-size: 11px;font-family: arial">
<table>
...
<h1>SCREEN 3 - Brothers 12.30pm (U/A HINDI)</h1>
</div>
<br>
<div style="background-color:white">
<span class="__text" style="font-size:20px;">All EYES THIS WAY PLEASE</span>
</div>
<br><br>
</td></tr>
<tr><td width="100%" align="center">
...
@ mysql_select_db("tickets5") or die("Could not select database");
