		...
		function reserveSeats() {
			...
			if (selectedList) {
				if (confirm('Do you want to reserve selected seat/s ' + selectedList + '?')) {
					...
					document.forms[0].action='bookseats3.php'; //Change
...
<a href="http://localhost/Project/Registration/logOut.php"style="font-family: Comic Sans MS, cursive, sans-serif; font-size: 15px;color:Orange;">Logout</a>
...
<h1>SCREEN 2 - Everest 12.30pm (U/A ENGLISH)</h1>
</div>
<br>
<div style="background-color:white">
...
@ mysql_select_db("tickets3") or die("Could not select database"); //Change
